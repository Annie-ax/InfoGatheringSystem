    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> 清除所有</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> 重新缓存</a></li>
          </ul>
        </li>
      </ul>
    </section>
          ...
          <div class="box-body table-responsive no-padding">
            ...
            <div class="pageDiv">
              <ul class="pagination" id="pageShow">
                <li><a href="/pageQuery?currentPage=${page }&pageSum=${pageSum }&flag=0&tableName=${tableName }">&laquo;</a></li>
                <c:forEach items="${pageList }" var="currentPage">
                  <li><a href="/pageQuery?currentPage=${currentPage }&pageSum=${pageSum }&flag=1&tableName=${tableName }">${currentPage }</a></li>
                </c:forEach>
                <li><a href="/pageQuery?currentPage=${page }&pageSum=${pageSum }&flag=2&tableName=${tableName }">&raquo;</a></li>
