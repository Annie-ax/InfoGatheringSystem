    ...
    <section class="content">
      <div class="row">
          ...
          <div class="box box-primary">
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="/Logquery" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>日志等级</label>
                    <input type="text" class="form-control" name="level" placeholder="Enter ..." style="width: 30%;">
                  </div>
                  <div class="form-group">
                    <label>进程号</label>
                    <input type="text" class="form-control" name="pid" placeholder="Enter ..." style="width: 30%;">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
